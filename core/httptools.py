...
def downloadpage(url, **opt):
    ...
    CF = False
    if domain in ['guardaserie.media', 'casacinema.space', 'wstream.video', 'akvideo.stream', 'backin.net',
                  'dreamsub.stream', 'altadefinizione-nuovo.link', 'ilgeniodellostreaming.ch', 'www.piratestreaming.gratis',
